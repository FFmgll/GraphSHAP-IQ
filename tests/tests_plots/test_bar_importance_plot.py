"""This test module tests the bar importance plot function in the shapiq package."""
...
from shapiq.plot import bar_importance_plot


@pytest.mark.parametrize("max_order", [1, 2, 3])
def test_bar_importance_plot(max_order):
    ...
    # test force plot
    fig, ax = bar_importance_plot(interaction_values)
